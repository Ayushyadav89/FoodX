import {foodItem} from './fooditem1.js'

function displayItems(){
    var pizza= document.getElementById('pizza');
    var paneer=  document.getElementById('paneer');;
    var dosa=  document.getElementById('dosa');
    var chiense=  document.getElementById('chiense');
    ...
    const dosaData= foodItem.filter((item)=>item.category=='dosa');
    const PaneerData= foodItem.filter((item)=>item.category=='paneer');
    const chienseData= foodItem.filter((item)=>item.category=='chiense');
    const northData= foodItem.filter((item)=>item.category=='north');
